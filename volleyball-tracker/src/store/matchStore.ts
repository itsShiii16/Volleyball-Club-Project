...
const POG_MULTIPLIERS: Record<RoleKey, Record<StatKey, number>> = {
  ...
  SETTER: { SERVE_ACE: 2, SERVE_SUCCESS: 0, SERVE_ERROR: -2, RECEPTION_EXC: 0, RECEPTION_ATT: 0, RECEPTION_ERR: 0, DIG_EXC: 2, DIG_ATT: 1, DIG_ERR: 0, ATTACK_KILL: 1, ATTACK_ATT: 0, ATTACK_ERR: -2, BLOCK_KILL: 2, BLOCK_ERR: -2, SET_EXC: 2, SET_RUN: 0.25, SET_ERR: -2 },
};
